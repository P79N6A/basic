...
public class IntegerDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("欢迎进入基本数据类型学习");
        System.out.println("/*************************************************************************************************************/");
        Integer i = 100;
        Integer j = 100;
        ...
        Long p = 200l;
        int q = 200;
        System.out.println(p.equals(o + m));
        System.out.println(p.equals(m + n));
        /*
         *当等号两边是表达式时 比较的是表达式的值
         * */
        System.out.println(p == o + m);
        System.out.println(q == m + o);
        System.out.println(q == p);
        System.out.println("/*************************************************************************************************************/");
        System.out.println("知识点回顾结束");
    }
}
